...
import { Eye, RefreshCw, Filter, AlertCircle, Plus, Copy, Calendar, ChevronDown, ChevronUp, ChevronRight, ChevronLeft, Search } from "lucide-react"
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-3">
                  <div className="space-y-1">
                    ...
                    <Select value={filtroOrigem} onValueChange={setFiltroOrigem}>
                      <SelectTrigger className="h-11 bg-white border-gray-200"><SelectValue placeholder="Origem" /></SelectTrigger>
                      <SelectContent>
                  ...
                  <div className="space-y-1">
                    ...
                    <Select value={filtroStatus} onValueChange={setFiltroStatus}>
                      <SelectTrigger className="h-11 bg-white border-gray-200"><SelectValue placeholder="Status" /></SelectTrigger>
                      <SelectContent>
                  ...
                  <div className="space-y-1">
                    ...
                    <Popover>
                      <PopoverTrigger asChild>
                        <Button variant="outline" className="h-11 justify-start text-left font-normal w-full bg-white border-gray-200">
                          <Calendar className="mr-2 h-4 w-4 text-gray-400" />
                          {filtroDataInicio ? format(filtroDataInicio, "dd/MM/yyyy") : "Data Início"}
                        </Button>
                      </PopoverTrigger>
                      <PopoverContent className="w-auto p-0 z-[100]" align="start">
                        <CalendarComponent mode="single" selected={filtroDataInicio} onSelect={setFiltroDataInicio} locale={ptBR} />
                      </PopoverContent>
                    </Popover>
                  </div>
                  <div className="space-y-1">
                    ...
                    <Popover>
                      ...
                      <PopoverContent className="w-auto p-0 z-[100]" align="start">
                        <CalendarComponent mode="single" selected={filtroDataFim} onSelect={setFiltroDataFim} locale={ptBR} />
                      </PopoverContent>
                    </Popover>
                  </div>
                  <div className="space-y-1">
            ...
            <div className="bg-white">
              <div className="md:hidden divide-y divide-gray-100">
                {loading ? (
                  ...
                  pedidos.map((pedido) => (
                    <div key={pedido.ID} onClick={() => abrirPedido(pedido)} className="p-4 active:bg-gray-50 transition-colors">
                      ...
                      pedidos.map((pedido) => (
                        <TableRow key={pedido.ID} className="hover:bg-gray-50/50 cursor-pointer" onClick={() => abrirPedido(pedido)}>
                          ...
                          <TableCell className="text-right">
                            <Button variant="ghost" size="sm" onClick={(e) => { e.stopPropagation(); abrirPedido(pedido); }} className="h-8 w-8 p-0"><Eye className="w-4 h-4 text-gray-500" /></Button>
                            <Button variant="ghost" size="sm" onClick={(e) => { e.stopPropagation(); duplicarPedido(pedido); }} className="h-8 w-8 p-0"><Copy className="w-4 h-4 text-gray-500" /></Button>
                          </TableCell>
                        </TableRow>
                      ))
                    )}
